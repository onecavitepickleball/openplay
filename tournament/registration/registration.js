...
const { watchAuth, login, logout, watchControl, watchRegistrations, createRegistration, updateRegistration, deleteRegistration, publishControl } = await import(`../firebase-sync.js?v=${encodeURIComponent(revision)}`);
