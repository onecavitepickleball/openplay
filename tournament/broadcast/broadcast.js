...
(() => {
  ...
  function enabledCourtNumbers() { return Object.keys(state?.courts || {}).map(Number).filter(no => state?.courtAvailability?.[no] !== false); }
