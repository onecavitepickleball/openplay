...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const SEARCH_PAGES = [
    ...
    { title: 'Shop', desc: 'All OCPC gear — uniform, T-Shirt v1, and more', url: '/merch/' },
    { title: 'OCPC Sublimation Uniform', desc: 'Full sublimation polo jersey, ₱600', url: '/merch/uniform/' },
    { title: 'OCPC T-Shirt v1', desc: 'Heat press tee, ₱400, 8 colors', url: '/merch/tshirt-v1/' },
